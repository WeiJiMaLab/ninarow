...
class DefaultModel:
    ...
    def __init__(self):
        ...
        self.lb = np.array([0.1,    0.01,   0.  ,   0.05,   0.25,   -10.,   -10.,   -10.,   -10.,   -10.], dtype=np.float32)
        self.pub = np.array([6.0,   0.9,    0.5,    0.5,    2.0,    5.0,    5.0,    5.0,    5.0,    10.0 ], dtype=np.float32)
        self.plb = np.array([1.0,   0.01,   0.0,    0.05,   0.5,    -5.0,   -5.0,   -5.0,   -5.0,   -5.0 ], dtype=np.float32)
        self.c = 50
